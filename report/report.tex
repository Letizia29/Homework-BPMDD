...
The linear fit was repeated for two sub-groups of patients - males and females. The results are shown in Figure \ref{fig:lin_fit_males} and in Table \ref{tbl:R_squared_fit_males} for males, and in Figure \ref{fig:lin_fit_females} and in Table \ref{tbl:R_squared_fit_females} for females. The p-values were all $<<$ 0.001.
...
\begin{tabular}{|c|c|}
	\hline
	\textbf{ROIs}             & \textbf{adjusted $R^2$} \\ \hline
	\textbf{Caudate}          & 0.3307                  \\ \hline
	\textbf{Putamen}          & 0.3409                  \\ \hline
	\textbf{Putamen Anterior} & 0.2721                  \\ \hline
\end{tabular}
\caption{Adjusted $R^2$ values of the linear fit of males between lateralization and symptoms}
\label{tbl:R_squared_fit_males}
\end{table}
...
\begin{table}[h]
	...
	\begin{tabular}{|c|c|}
		\hline
		\textbf{ROIs}             & \textbf{adjusted $R^2$} \\ \hline
		\textbf{Caudate}          & 0.3354                  \\ \hline
		\textbf{Putamen}          & 0.4065                  \\ \hline
		\textbf{Putamen Anterior} & 0.3505                  \\ \hline
	\end{tabular}
	\caption{Adjusted $R^2$ values of the linear fit of females between lateralization and symptoms}
	\label{tbl:R_squared_fit_females}
\end{table}

\begin{multicols}{2}


CICLO CAMBIANDO COVARIATE

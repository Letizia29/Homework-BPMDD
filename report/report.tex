...
This threshold level was adopted from a previous study \cite{}.

This reasoning allowed the removal of some subjects not having a significant lateralization, and therefore the analysis was carried out with TOT subjects. 

Through the Pearson pairwise correlation, the group analysed the correlation coefficients of the relevant variables, such as all the NP tests, ENROLL\_AGE, WEIGHT, HEIGHT, and MCATOT, with the lateralization index. For the analysis, were kept only the significant ones, with p-value < 0.05, and correlation coefficient higher than 0.5.
